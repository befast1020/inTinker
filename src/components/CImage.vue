...
<template>
    <div class="desktop-only vertical-slider">
        <div class="right-side">
            <section class="content-wrapper" data-index="0"></section>
            <section class="content-wrapper" data-index="1"></section>
            <section class="content-wrapper" data-index="2"></section>
        </div>
        <div class="left-side">
            <div class="sticky">
